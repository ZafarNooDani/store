...
from customer.views import Index, Menu, login_view, register, product, LogoutView, product_list, user_orders, add_to_cart, remove_from_cart, view_cart, view_order, user_profile, user_change_pass
